...
\begin{alltt}
\hldef{dat} \hlkwb{<-} \hlkwd{read.table}\hldef{(}\hlsng{"data-6.1"}\hldef{,}\hlkwc{header}\hldef{=T)}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(file, "{}rt"{}): cannot open file 'data-6.1': No such file or directory}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in file(file, "{}rt"{}): cannot open the connection}}\begin{alltt}
\hldef{x} \hlkwb{<-} \hldef{dat}\hlopt{$}\hldef{s230}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'dat' not found}}\begin{alltt}
\hldef{y} \hlkwb{<-} \hldef{dat}\hlopt{$}\hldef{s231}
\end{alltt}
...
\hldef{ybar} \hlkwb{<-} \hlkwd{mean}\hldef{(y)}
\end{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'x' not found}}\begin{alltt}
\hldef{Sxx} \hlkwb{<-} \hlkwd{sum}\hldef{(x}\hlopt{^}\hlnum{2}\hldef{)}\hlopt{-}\hldef{n}\hlopt{*}\hldef{(}\hlkwd{mean}\hldef{(x))}\hlopt{^}\hlnum{2}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'x' not found}}\begin{alltt}
\hldef{Syy} \hlkwb{<-} \hlkwd{sum}\hldef{(y}\hlopt{^}\hlnum{2}\hldef{)}\hlopt{-}\hldef{n}\hlopt{*}\hldef{(}\hlkwd{mean}\hldef{(y))}\hlopt{^}\hlnum{2}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'y' not found}}\begin{alltt}
\hldef{Sxy} \hlkwb{<-} \hlkwd{sum}\hldef{(x}\hlopt{*}\hldef{y)}\hlopt{-}\hldef{n}\hlopt{*}\hlkwd{mean}\hldef{(x)}\hlopt{*}\hlkwd{mean}\hldef{(y)}
\end{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'Sxx' not found}}\begin{alltt}
\hldef{Syy}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'Syy' not found}}\begin{alltt}
\hldef{Sxy}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'Sxy' not found}}\begin{alltt}
\hldef{r} \hlkwb{<-} \hldef{Sxy}\hlopt{/}\hlkwd{sqrt}\hldef{(Sxx}\hlopt{*}\hldef{Syy)}
\end{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'r' not found}}\end{kframe}
\end{knitrout}
    %\end{noindent}
    %\begin{noindent}
\begin{knitrout}
