...
\begin{Example}{$ 95\% $ Confidence Interval for the Mean STAT 231 Final Grade}{}
    Since
    \[ P(T\leq 2.0484)=\frac{1+0.95}{2}=0.975\quad\text{where}\quad T\sim t(28) \]
...
where
\[ P(U\leq a)=\frac{1-p}{2}=P(U>b),\quad\text{where}\quad U\sim \chi^2(n-2) \]
...
\begin{Example}{Hand Span Example: $ 95\% $ Confidence Interval for $ \mu_1-\mu_2 $}{}
    Using R, we obtain $ P(T\leq 1.97705)=0.975 $, where $ T\sim t(140) $.
...
\[
    \hat{\Vector{\theta}}_{j}=\frac{\Vector{y}_{j}}{n}, \quad j=1,2, \ldots, k
\]
